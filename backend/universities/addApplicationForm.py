...
def addApplication(name, data, id):
    print("""	
	<div class="container">
        <div class="row">
			<h2>%s</h2>
	...
	<div class="container">
        <div class="row">
            <div class="col-sm-6 col-sm-offset-3 col-xs-12">
                <form name="addprogram" action="addApplicatoinSubmit.py" method="POST"> 
                    <hr />
                    <div class="row">
                    ...
                    </div> """%(data[0],data[0],data[1],data[1]))
    print("""
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <input type="date" name="startDate" id="startDate" class="form-control" value="" placeholder="Start Date">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <input type="text" name="fees" id="fees" class="form-control" value="" placeholder="Application fees">
                            </div>
                        </div>
                    </div>  
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <input type="date" name="applicationDeadline" id="applicationDeadline" class="form-control" value="" placeholder="application Deadline">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <input type="date" name="dateofEnrollment" id="dateofEnrollment" class="form-control" value="" placeholder="Date of Enrollment">
                            </div>
                        </div>
                    </div>
                    <hr />
...
try:
    data = (cgi.escape(form['programName'].value), cgi.escape(form['programType'].value),
            cgi.escape(form['universityId'].value))
    ...
    if "HTTP_COOKIE" in os.environ:
        ...
        if row:
            navBar(row[5])
            c.execute(
                '''SELECT * FROM university WHERE UniversityID = %s''' % (cgi.escape(form['universityId'].value),))
            uni = c.fetchone()
            addApplication(uni[1], data, cgi.escape(form['universityId'].value))
