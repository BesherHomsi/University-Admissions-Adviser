	...
	<div class="container">
        <div class="row">
            <div class="col-sm-6 col-sm-offset-3 col-xs-12">
                <form name="addprogram" action="addTuitionFeeSubmit.py" method="POST"> 
                    <hr />
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <input type="text" name="scholarshipName" id="programName" class="form-control" value="" placeholder="Scholarship Name">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <input type="text" name="scholarshipDescription" id="scholarshipDescription" class="form-control" value="" placeholder="Scholarship Description">
                            </div>
                        </div>
                    </div> 
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <input type="text" name="reduction" id="reduction" class="form-control" value="" placeholder="Reduction Percentage">
                            </div>
                        </div>
                    </div>  
                    <hr />
