...
def Menu():
    print("""<ul class="">
          <li class="">
            <a class="btn btn-outline-success" href="displayApplicatoinsDocuments.py?q=%s" style="margin:10px;">Add Document</a>
          </li>
          <li class="">
            <a class="btn btn-outline-success" href="displayApplicatoinsExam.py?q=%s" style="margin:10px;">Add Examination Requirment</a>
          </li>
        </ul>""")
