...
def addDocuments(name, data, id):
	...
	<div class="container">
        <div class="row">
            <div class="col-sm-6 col-sm-offset-3 col-xs-12">
                <form name="addprogram" action="addDocumentSubmit.py" method="POST"> 
                    <hr />
                    <div class="row">
    ...
    print("""	
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <input type="text" name="DocumentName" id="DocumentName" class="form-control" value="" placeholder="Document Name">
                            </div>
                        </div>
                    </div>
                    <div class="row">
