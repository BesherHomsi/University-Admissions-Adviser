...
def editProfile(id,uni):
	print("""<div class="container">
        <div class="row">
            <div class="col-sm-6 col-sm-offset-3 col-xs-12">
                <form name="submitEditProfileA" action="submitEditProfileU.py" method="POST"> 
                    <hr />
                    <div class="row">
	...
	print("""
					...
					<input type="text" name="uId" id="uId" class="form-control" value=%s placeholder="acId" style="visibility: hidden;">
                    <hr />
                    <div class="row">
