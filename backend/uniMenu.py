...
def userMenu():
	print("""<ul class="">
          <li class="">
            <a class="btn btn-outline-success" href="uniDetailsForm.py" style="margin:10px;">More Details</a>
          </li>
          <li class="">
            <a class="btn btn-outline-success" href="#" style="margin:10px;">Add a program</a>
          </li>
          <li class="">
            <a class="btn btn-outline-success" href="#" style="margin:10px;">Add an Applicaiton</a>
          </li>
          <li class="">
